...
`;
    ...
    const handleExportPDF = async () => {
        ...
        pdfHeader.innerHTML = `
            <svg width="40" height="40" viewBox="0 0 32 32" fill="none" xmlns="/public/image.png">
        ...
        const opt = {
            margin: 10,
            filename: `IdeaFlow-${query.replace(/\s+/g, '-').slice(0, 20)}.pdf`,
        ...
        // Wait for styles to settle (crucial for high contrast)
